...
Về cách dùng con trỏ nhanh-chậm và con trỏ trái-phải của hai con trỏ, có thể xem bài trước [Tổng hợpkỹ thuật hai con trỏ](https://labuladong.online/algo/essential-technique/array-two-pointers-summary/), bài này sẽ giải một loạikỹ thuật hai con trỏ khó nắm nhất:kỹ thuật cửa sổ trượt. và tổng kết một bộ khung, có thể保你 nhắm mắt cũng viết ra cách giải đúng.
...
ý tưởngkỹ thuật thuật toán cửa sổ trượt cũng không khó, chính làduy trì một cửa sổ, không ngừng trượt, rồi cập nhật đáp án, logic đại khái của thuật toán如下:
...
Nên trong [Bản chất thuật toán](https://labuladong.online/algo/essential-technique/algorithm-summary/) tôi đem thuật toán cửa sổ trượt归 vào loại "làm saovét cạn thông minh".
...
**Nên hôm nay tôi sẽ viết một bộ khung code thuật toán cửa sổ trượt, tôi liền ở đâu làm output debug cũng viết sẵn cho bạn, sau này gặp vấn đề liên quan, bạn sẽ viết ra từ trí nhớ ra khung如下 rồi sửa ba chỗ là được, đảm bảo không ra bug**.
...
Nói ngoài lề, có độc giả bình luận khung này của tôi, nói bảng băm tốc độ chậm, không bằng dùng mảng thay bảng băm; còn có người thích đem code viết đặc biệt ngắn gọn, nói tôi code như vậy太 nhiều dư, tốc độ không 够 nhanh. Ý kiến của tôi là, thuật toán chủ yếu xem độ phức tạp thời gian, bạn có thể đảm bảo độ phức tạp thời gian của mình tối ưu là được. Còn tốc độ chạy LeetCode, cái đó hơi huyền học, chỉ cần không phải chậm quá đáng sẽ không vấn đề gì, căn bản không đáng bạn từ phạm vi biên dịch tối ưu, đừng舍 gốc 逐末...

Lại nói, giáo trình thuật toán của tôi trọng điểm nằm ở tư tưởng thuật toán, bạn trước 做 tới có thể đem tư duy khung vận dụng thành thạo, rồi tùy bạn tùy biến code tốt, 保你 viết sao cũng viết đúng.
...
ý tưởng này thực ra cũng không khó, **bước 2tương đương với đang tìm một "nghiệm khả thi", rồi bước 3 đang tối ưu "nghiệm khả thi" này, cuối cùng tìm giải tối ưu**, cũng chính là chuỗi phủ ngắn nhất. Con trỏ trái-phải luân phiên tiến, kích thước cửa sổ tăng tăng giảm giảm, sẽ tốt giống một con sâu毛毛, một伸 một缩, không ngừng trượt sang phải, đây chính là lai lịch tên "cửa sổ trượt".

Dưới đây vẽ图 hiểu một chút, `needs` và `window`tương đương với bộ đếm, lần lượt ghi số lần ký tự trong `T` xuất hiện và số lần xuất hiện của ký tự tương ứng trong "cửa sổ".
...
Đến đây, hẳn có thể hoàn toàn hiểu bộ khung này, thuật toán cửa sổ trượt lại không khó, chính là vấn đề chi tiết khiến người烦 được 很.**Sau này gặp thuật toán cửa sổ trượt, bạn cứ theo khung này viết code, bảo đảm không có bug, còn đỡ việc**.
...
haha, cái gọi là từ dị vị này, chẳng phải chính là hoán vị sao, bày ra một cách nói cao端 là có thể đánh lừa người sao?** tương đương, nhập một chuỗi `S`, một chuỗi `T`, tìm trong `S` mọi hoán vị của `T`, trả về chỉ số bắt đầu của chúng**.
...
Tôi trong [Bài tập kinh điển cửa sổ trượt](https://labuladong.online/algo/problem-set/sliding-window/) dùng bộ mô thức tư duy này liệt kê thêm nhiều bài tập kinh điển, nhằm强 hóa hiểu và nhớ của bạn với thuật toán, sau này sẽ lại cũng không sợ vấn đề chuỗi con, mảng con.
