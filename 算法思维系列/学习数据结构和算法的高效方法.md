...
> tip: Bài này có bản video: [Học tư duy khung của cấu trúc dữ liệu và thuật toán](https://www.bilibili.com/video/BV1EN4y1M79p/). Khuyên theo dõi tài khoản Bilibili của tôi, tôi sẽ dùng cách đọc dẫn bằng video để带 mọi người học nhữngkỹ thuật thuật toán hơi khó.
...
Trước hết, chỗ nàygiảng đều là cấu trúc dữ liệu thông thường, chúng ta không phải thi thuật toán竞赛, mục đích của chúng ta là nhanh chóng nâng cao năng lực thuật toán, bồi dưỡng tư duy thuật toán, thật không cần nguyên đề quá偏 quá怪. Ngoài ra, dưới đây là tổng kết kinh nghiệm cá nhân của tôi, không có sách thuật toán nào viết những thứ này, nên mong độc giả thử hiểu góc độ của tôi, đừng băn khoăn vào vấn đề chi tiết, vì bài này chính là hy vọng giúp bạn建立 một nhận thức mang tính khung với cấu trúc dữ liệu và thuật toán.
...
Chúng ta phân tích vấn đề, nhất định phải có tư duy đệ quy, từ trên xuống dưới, từ trừu tượng đến cụ thể. Bạn上来 sẽ liệt kê nhiều như vậy, những cái đó đều thuộc "kiến trúc thượng tầng", mà mảng và danh sách liên kết mới là "cơ sở kết cấu". Vì những cấu trúc dữ liệu đa dạng đó, 究 nó nguồn gốc, đều là thao tác đặc biệt trên danh sách liên kết hoặc mảng, API khác nhau mà thôi.
...
Hai cách biểu diễn của "đồ thị", danh sách kề chính là danh sách liên kết, ma trận kề chính là mảng hai chiều. Ma trận kềkiểm tra tính liên thông nhanh chóng, 並 có thể tiến hành phép toán ma trận giải một số vấn đề, nhưng nếu đồ thị khá thưa thì rất tốn không gian. Danh sách kề khá tiết kiệm không gian, nhưng nhiều thao tác về hiệu suất chắc chắn hơn có điều ma trận kề.

"Bảng băm" chính là thông qua hàm băm ánh xạ khóa vào một mảng lớn. Mà với phương pháp giải xung đột băm, phương pháp móc xích cần đặc tính danh sách liên kết, thao tác đơn giản, nhưng cần không gian thêm để lưu con trỏ; phương pháp探 đo tuyến tính sẽ cần đặc tính mảng, để寻址 liên tục, không cần không gian lưu con trỏ, nhưng thao tác hơi phức tạp.
...
Tổng hợp, loại cấu trúc dữ liệu rất nhiều, thậm chí bạn cũng có thể phát minh cấu trúc dữ liệu của mình, nhưng lưu tầng đáy chẳng qua cũng chỉ là mảng hoặc danh sách liên kết, **ưu khuyết điểm của hai者 như sau**:

**Mảng** do lưu liền kề liên tục, có thể truy cập ngẫu nhiên, thông qua chỉ số tìm nhanh phần tử tương ứng, mà tương đối tiết kiệm không gian lưu. Nhưng đang vì lưu liên tục, không gian bộ nhớ bắt buộc một lần phân đủ, nên nói mảng nếu muốn mở rộng, cần phân lại một块 không gian lớn hơn, rồi đem dữ liệu toàn bộ copy qua, độ phức tạp thời gian O(N); hơn nữa nếu bạn muốn ở giữa mảng tiến hành chèn và xóa, mỗi lần bắt buộc di chuyển tất cả dữ liệu phía sau để giữ liên tục, độ phức tạp thời gian O(N).

**Danh sách liên kết** vì phần tử không liên tục, mà靠 con trỏ chỉ vị trí phần tử tiếp theo, nên không tồn tại vấn đề mở rộng của mảng; nếu biết tiền驱 và hậu驱 của một phần tử nào đó, thao tác con trỏ là có thể xóa phần tử đó hoặc chèn phần tử mới, độ phức tạp thời gian O(1). Nhưng đang vì không gian lưu không liên tục, bạn không thể căn cứ một chỉ số tính ra địa chỉ phần tử tương ứng, nên không thể truy cập ngẫu nhiên; hơn nữa do mỗi phần tử bắt buộc lưu con trỏ chỉ vị trí phần tử trước sau, sẽ tốn tương đối nhiều không gian lưu hơn.
...
Bạn xem cách duyệt đệ quy của cây nhị phân và cách duyệt đệ quy của danh sách liên kết, có giống không? Nhìn lại cấu trúc cây nhị phân và cấu trúc danh sách đơn, có giống không? Nếu thêm vài 条叉, cây N phân bạn có sẽ duyệt không?
...
Duyệt cây `N` phân lại có thể mở rộng thành duyệt đồ thị, vì đồ thị chính là vài cây `N` phân kết hợp体. Bạn nói đồ thị có thể xuất hiện chu trình? Chuyện này rất dễ, dùng một mảng bool `visited` làm đánh dấu là được, chỗ này sẽ không viết code.

**Cái gọi là khung, chính làcông thức. Bất kể thêm xóa tìm sửa, những code này đều mãi mãi không thể脱离 kết cấu**, bạn có thể lấy kết cấu này làm lớn 纲, căn cứ vấn đề cụ thể thêm code trên khung là được, dưới đây sẽ lấy ví dụ cụ thể.
...
Vì những thuật toán này thuộc loại biết rồi thì không thấy khó, chưa biết thì thấy khó, độ khó không lớn, học chúng sẽ không tốn nhiều thời gian. Mà những thuật toán nhỏ mà đẹp này thường khiến bạn lớn 呼 tinh妙, có thể bồi dưỡng hiệu quả hứng thú của bạn với thuật toán.

**2, Học xong thuật toán cơ bản, đừng vội上来 sẽ luyện đề thường thi như thuật toán quay lui, quy hoạch động, mà hẳn刷 cây nhị phân trước, 刷 cây nhị phân trước, 刷 cây nhị phân trước**, chuyện quan trọng nói ba lần.
...
Đây là thể hội親 thân nhiều nămluyện đề của tôi, hình dưới là ảnh chụp提交 lúc tôi mới bắt đầu học thuật toán:

![](https://labuladong.online/algo/images/others/leetcode.jpeg)

Dữ liệu đọc bàikênh WeChat chính thức cho thấy, đa số người với bài thuật toán liên quan cấu trúc dữ liệu không hứng thú, mà quan tâm hơn đếnkỹ thuật như động quy quay lui chia trị. Tại sao cần 刷 cây nhị phân trước, **vì cây nhị phân dễ nhất bồi dưỡng tư duy khung, mà tất cảkỹ thuật thuật toán đệ quy, bản chất đều là vấn đề duyệt cây**.

刷 cây nhị phân thấy đề không cóý tưởng? căn cứ vấn đề của nhiều độc giả, thực ra mọi người không phải không cóý tưởng, chỉ là không hiểu "khung" mà chúng ta nói là gì.
...
Ví dụ tôi tùy ý lấy cách giải vài bài đề ra, không cần管 logic code cụ thể, chỉ cần xem khung trong đó phát huy tác dụng thế nào là được.
...
LeetCode 105, độ khó trung bình, bắt bạn căn cứ kết quả duyệt tiền thứ và trung thứ还原 một cây nhị phân, vấn đề rất kinh điển, code chính như sau:
...
Với một người hiểu cây nhị phân, 刷 một đề cây nhị phân tốn không bao lâu. Vậy nếu bạn vớiluyện đề không biết bắt đầu từ đâu hoặc có tâm lý sợ hãi, không ngại bắt đầu từ cây nhị phân, 10 đạo đầu có lẽ hơi khó chịu; kết hợp khung làm thêm 20 đạo, có lẽ bạn thì có chút hiểu của mình;刷 xong toàn bộ chuyên đề, rồi đi làm chuyên đề quay lui động quy chia trị, **bạn sẽ phát hiện chỉ cần liên quan vấn đề đệ quy, đều là vấn đề cây**.

::: tip

[Chương luyện tập chuyên đề cây nhị phân](https://labuladong.online/algo/problem-set/binary-tree-traverse-1/) của gốc trạm theo công thức và mô thức tư duy cố địnhgiảng 150 đề cây nhị phân, có thể cầm tay带你刷 hết đề phân loại cây nhị phân, nhanh chóng nắm tư duy đệ quy.

:::

Lấy ví dụ nữa, nói vài bài vấn đề bài viết trước của chúng ta từng viết.

[giải chi tiết quy hoạch động](https://labuladong.online/algo/essential-technique/dynamic-programming-framework/) từng nói bài toán gom tiền lẻ, cách giải 暴 sức chính là duyệt một cây N phân:
...
Nhiều code như vậy xem không hiểu咋办? Trực tiếp rút ra khung, là có thể nhận ra ý tưởng cốt lõi:
...
Nhìn vấn đề từ khung, chính là giống chúng ta như vậy dựa trên khung tiến hành rút ra và mở rộng, vừa có thể khi xem cách giải người khác nhanh chóng hiểu logic cốt lõi, cũng có 助 ở tìm hướngý tưởng khi chúng ta tự viết cách giải.
...
Học xong thuật toán cơ bản, khuyên bắt đầu刷 từ vấn đề loạt "cây nhị phân", kết hợp tư duy khung, đem cấu trúc cây hiểu tới bit, rồi đi xem chuyên đề quay lui, động quy, chia trị, hiểuý tưởng sẽ càng sâu sắc.
...
<summary><strong>Bài viết trích dẫn bài này</strong></summary>
 ...
 - [Đông ca带你刷 cây nhị phân (loạt tuần tự hóa)](https://labuladong.online/algo/data-structure/serialize-and-deserialize-binary-tree/)
 - [Đông ca带你刷 cây nhị phân (loạt cương lĩnh)](https://labuladong.online/algo/essential-technique/binary-tree-summary/)
 ...
 - [Đề không cho tôi làm gì, tôi偏 cần làm nấy](https://labuladong.online/algo/data-structure/flatten-nested-list-iterator/)
