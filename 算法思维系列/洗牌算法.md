...
Tôi biết mọi người sẽ đủ loại thuật toán sắp xếp hoa hòe, nhưng nếu叫你 xáo trộn một mảng, liệu bạn có做 tới nắm chắc trong lòng? Dù bạn nghĩ bừa nghĩ ra một thuật toán, làm sao chứng minh thuật toán của bạn chính là đúng? Thuật toán xáo trộn không giống thuật toán sắp xếp, kết quả duy nhất có thể rất dễ kiểm nghiệm, vì "loạn" có thể có rất nhiều loại, bạn làm sao chứng minh thuật toán của bạn là "thật sự loạn"?

Nên chúng ta đối mặt hai vấn đề:

1. Thế nào gọi là "thật sự loạn"?

2. Thiết kế thuật toán thế nào để xáo trộn mảng mới做 tới "thật sự loạn"?

Loại thuật toán này gọi là "thuật toán đặt ngẫu nhiên" hay "thuật toán xáo trộn Fisher-Yates".

Bài này chia hai phần, phần mộtgiải chi tiết thuật toán xáo trộn hay dùng nhất. Vì chi tiết của thuật toán này dễ sai, mà tồn tại vài loại biến thể, tuy có差异细微 nhưng đều đúng, nên bài này cần giới thiệu một tư tưởng tổng quát đơn giản đảm bảo bạn viết ra thuật toán xáo trộn đúng. Phần haigiảng dùng "phương pháp Monte Carlo" để kiểm nghiệm kết quả xáo trộn của chúng ta có phải thật sự loạn không. Tư tưởng phương pháp Monte Carlo không khó, nhưng cách cài đặt cũng mỗi có đặc điểm.
...
Phân tích**cách viết thứ hai**, các lần lặp phía trước đều giống nhau, chỉ ít một lần lặp mà thôi. Nên lần lặp cuối cùng时 `i = 3`, phạm vi giá trị của `rand` là `[3, 4]`, có 2 giá trị có thể.
...
Thuật toán xáo trộn, hay nói là tiêu chuẩn đo lường tính đúng đắn của thuật toán đặt ngẫu nhiên là:**với mỗi kết quả có thể thì xác suất xuất hiện bắt buộc bằng nhau, tức là nói cần 足够 ngẫu nhiên**.
...
Chuyện này thực ra chính là lợi dụng phương pháp Monte Carlo: khi điểm ném足够 nhiều 时, số lượng điểm là có thể近似 đại diện diện tích hình. Thông qua công thức diện tích, từ tỷ số diện tích hình vuông và hình tròn có thể rất dễ suy ra số pi. Đương nhiên điểm ném càng nhiều, số pi tính ra càng chính xác, 充 chia thể hiện chân lý sức mạnh tạo nên kỳ tích.

Tương tự, chúng ta có thể với cùng một mảng tiến hành một triệu lần xáo trộn, thống kê số lần mỗi loại kết quả xuất hiện, lấy tần suất làm xác suất, có thể rất dễ nhận ra thuật toán xáo trộn có đúng không. Tư tưởng tổng thể rất đơn giản, có điều cài đặt起来 cũng có chútkỹ thuật, dưới đây phân tích đơn giản vàiý tưởng cài đặt.
...
Mỗi lần tiến hành thuật toán xáo trộn xong, rồi đem 频数 tương ứng của kết quả xáo trộn thu được cộng một, lặp lại 1 triệu lần, nếu tổng số lần mỗi loại kết quả xuất hiện gần như, vậy thì cho thấy xác suất mỗi loại kết quả xuất hiện hẳn bằng nhau. Viết mã giả củaý tưởng này:
...
Đúng, có điều làm phương pháp kiểm chứng, chúng ta không cần n quá lớn, thường dùng arr độ dài 5 hoặc 6 thử下 sẽ gần như, vì chúng ta chỉ muốn so sánh xác suất kiểm chứng tính đúng mà thôi.

**ý tưởng thứ hai**, có thể nghĩ như vầy, mảng arr中 toàn là 0, chỉ có một số 1. Chúng ta với arr tiến hành 1 triệu lần xáo trộn, ghi lại số lần số 1 xuất hiện ở mỗi vị trí chỉ số, nếu số lần mỗi chỉ số xuất hiện gần như, cũng có thể giải thích xác suất mỗi loại kết quả xáo trộn bằng nhau.
...
Phần hai viết tiêu chuẩn đo lường tính đúng của thuật toán xáo trộn, tức xác suất mỗi loại kết quả ngẫu nhiên xuất hiện bắt buộc bằng nhau. Nếu chúng ta không dùng chứng minh toán học chặt chẽ, có thể thông qua phương pháp Monte Carlo sức mạnh tạo nên kỳ tích, kiểm chứng thô tính đúng của thuật toán. Phương pháp Monte Carlo cũng cóý tưởng khác nhau, có điều yêu cầu không必太严格, vì chúng ta chỉ寻 tìm một kiểm chứng đơn giản.
