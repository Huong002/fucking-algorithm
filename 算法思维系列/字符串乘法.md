...
Với những con số tương đối nhỏ, làm phép tính có thể dùng trực tiếp toán tử mà ngôn ngữ lập trình cung cấp, nhưng nếu hai thừa số相乘 rất lớn, kiểu dữ liệu mà ngôn ngữ cung cấp có thể bị tràn số. Một phương án thay thế là: toán hạng được nhập dưới dạng chuỗi, sau đó mô phỏng quá trình tính nhẩm phép nhân như hồi tiểu học để tính ra kết quả, và kết quả cũng được biểu diễn bằng chuỗi.

Xem LeetCode 43 「Nhân chuỗi」:

<Problem slug="multiply-strings" />

Cần lưu ý, `num1` và `num2` có thể rất dài, nên không thể chuyển trực tiếp chúng thành số nguyên rồi tính toán,思路 duy nhất là mô phỏng phép nhân tay của chúng ta.

Ví dụ ta tính tay `123 × 45`, sẽ tính như sau:

![](https://labuladong.online/algo/images/string-multiply/1.jpg)

Tính `123 × 5`, rồi tính `123 × 4`, cuối cùng cộng lệch một vị trí. Quy trình này恐怕 học sinh tiểu học cũng có thể thành thạo, nhưng liệu bạn có thể **máy móc hóa (cơ giới hóa) thêm quá trình tính toán này**, viết thành một bộ chỉ dẫn thuật toán để máy tính không có chút trí tuệ nào cũng thực thi được không?

Nhìn quá trình đơn giản này, trong đó liên quan đến nhớ khi nhân, cộng lệch vị trí, còn liên quan đến nhớ khi cộng; hơn nữa còn có một số vấn đề不易察觉, ví dụ số có hai chữ số nhân với số có hai chữ số, kết quả có thể là bốn chữ số, cũng có thể là ba chữ số, bạn làm sao nghĩ ra một cách xử lý chuẩn hóa? Đó chính là sự quyến rũ của thuật toán, nếu không có tư duy máy tính, vấn đề đơn giản cũng có thể không có cách nào xử lý tự động được.
...
**Tổng kết lại**, một số cách tư duy mà chúng ta习以为常, trong mắt máy tính lại rất khó làm được. Ví dụ quy trình số học mà chúng ta quen thuộc并不复杂, nhưng nếu bắt bạn tiến thêm một bước, dịch thành logic code,并不 đơn giản. Thuật toán cần đơn giản hóa thêm quy trình tính toán, thông qua cách vừa tính vừa cộng dồn để ra kết quả.

Tục ngữ dạy chúng ta, đừng rơi vào lối mòn tư duy, đừng程序 hóa, phải tư duy发散, phải sáng tạo. Nhưng tôi thấy程序 hóa并不是 chuyện xấu, có thể大幅提高 hiệu suất, giảm tỷ lệ sai sót. Thuật toán chẳng phải là một bộ tư duy được程序 hóa sao, chỉ có程序 hóa mới để máy tính giúp chúng ta giải quyết vấn đề phức tạp呀!

Có lẽ thuật toán chính là một loại **tư duy đi tìm lối mòn tư duy**吧, hy vọng bài viết này có ích với bạn.
